...
const EMAIL_SETTINGS = [
  ...
  'username' => 'maximzavidy@yandex.ru', // // SMTP-пользователь
...
if ($data['result'] == 'success' && HAS_SEND_EMAIL == true) {
  ...
  $search = ['%subject%', '%name%', '%email%', '%phone%', '%message%', '%date%'];
  $replace = [EMAIL_SETTINGS['subject'], $data['form']['name'], $data['form']['email'], $data['form']['phone'], $data['form']['message'], date('d.m.Y H:i')];
